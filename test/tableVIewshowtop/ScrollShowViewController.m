...
@interface ScrollShowViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation ScrollShowViewController
...
- (void)viewDidLoad {
    ...
    _circleView.image = [UIImage imageNamed:@"car.png"];
